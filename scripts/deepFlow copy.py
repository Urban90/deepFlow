...
def pipeline(path, extracted_path, splitted, model_aorta, masks_path_2, nifti_final, out_file, out_aorta):
    ...
    get_csv(ids, regurgitation, antegrade_flow_list, retrograde_flow_list, net_flow_list, aorta_perimeter_list, max_aorta_list, min_aorta_list, aorta_area_list, masks_v_max_list, masks_v_min_list, out_aorta)
...
def main():
    ...
    if os.path.isdir(folder_path) == False:
        print(f"You didn't provide a valid folder.\nTry again.\nThank you for using {software}!")
        exit()
    ...
    count = 0
    start = 0
    os.system(f"mkdir -p {extracted_path} {mag} {jpg_path} {out_aorta} {masks_path_2} {nifti_final} {failed_folder}")
